terraform {
  ...
  #
  # Camada persistente: nunca destruída pelo pipeline de CI/CD futuro
  # (ver frontend/specs/FEAT-07-terraform-import-infra/spec.md).
  backend "s3" {
    key          = "gastosapp-frontend/dns/terraform.tfstate"
