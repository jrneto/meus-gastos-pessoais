...
- [x] 1. Atualizar `styles/modernist/modernist.css`: novo token
      ...
      existentes
- [x] 2. Criar `features/summary/utils/month.ts` com
...
- [x] 3. Criar `features/summary/api/summaryApi.ts`: tipos
...
- [x] 4. Criar `features/summary/errors/summaryErrors.ts`:
      `SessionExpiredError`, `NetworkError`, `UnknownSummaryError`
      (mesmas mensagens padrão já usadas nas outras features)
- [x] 5. Criar `features/summary/hooks/useSummary.ts` (`useSummary(month)`
...
- [x] 6. Criar `features/summary/components/SummaryCards.tsx` e
...
- [x] 7. Criar `features/summary/components/CategorySpendingList.tsx`
...
- [x] 8. Criar `features/summary/components/RecentTransactionsList.tsx`
      ...
      estado vazio
- [x] 9. Atualizar `features/transactions/hooks/useTransactionsQuery.ts`:
...
- [x] 10. Atualizar `features/transactions/components/TransactionFilters.tsx`:
...
- [x] 11. Atualizar `routes/TransactionsListPage.tsx`: lê `yearMonth`
...
- [x] 12. Renomear `routes/HomePage.tsx` para `routes/DashboardPage.tsx`,
...
- [x] 13. Criar `routes/DashboardPage.test.tsx` cobrindo: renderiza os
      ...
      expirada
- [x] 14. Atualizar `app/router.tsx`: import/uso de `DashboardPage` no
      lugar de `HomePage`
- [x] 15. Atualizar `components/nav/navConfig.ts`: item `home` com
