...
- [ ] 1. Atualizar `features/transactions/hooks/useRegisterTransaction.ts`:
...
- [ ] 2. Atualizar `features/transactions/hooks/useUpdateTransaction.ts`:
...
- [ ] 3. Atualizar `features/transactions/components/TransactionForm.tsx`:
...
- [ ] 4. Atualizar `features/transactions/components/TransactionForm.test.tsx`:
...
- [ ] 11. Atualizar `routes/TransactionsListPage.tsx`: `TransactionFormTarget`
...
- [ ] 12. Atualizar `routes/TransactionsListPage.test.tsx`: remover/
