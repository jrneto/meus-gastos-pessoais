...
- [x] 1. Atualizar `styles/modernist/modernist.css`: nova classe
...
- [x] 2. Criar `features/reports/utils/period.ts` com `getCurrentDate()`,
...
- [x] 3. Criar `features/reports/api/reportsApi.ts`: tipos `ReportPeriod`,
      ...
      `summaryApi.ts`)
- [x] 4. Criar `features/reports/errors/reportsErrors.ts`:
      `SessionExpiredError`, `NetworkError`, `UnknownReportsError`
      (mesmas mensagens padrão já usadas nas outras features)
- [x] 5. Criar `features/reports/hooks/useReports.ts` (`useReports(period,
      ...
      `UnknownReportsError`
- [x] 6. Criar `features/reports/components/PeriodToggle.tsx` e
...
- [x] 7. Criar `features/reports/components/CategoryReportList.tsx` e
...
- [x] 8. Criar `features/reports/components/TotalPeriodCard.tsx` e
      ...
      é `null`
- [x] 9. Criar `features/reports/components/TopCategoryCard.tsx` e
      ...
      `null`
- [x] 10. Renomear `routes/ReportsComingSoonPage.tsx` (e seu teste) para
...
- [x] 11. Reescrever `routes/ReportsPage.test.tsx` (era
...
- [x] 12. Atualizar `app/router.tsx`: import/uso de `ReportsPage` no
