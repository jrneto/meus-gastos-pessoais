...
variable "infra_state_key" {
  description = "Key do state de terraform/environments/hom/ no repositório infra-jrnexpenses (DynamoDB, Cognito, Parameter Store, SES, API Gateway, domínio api-hom), lida via terraform_remote_state (FEAT-40)."
  type        = string
