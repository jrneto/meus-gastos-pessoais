...
public sealed partial class GetExpensesQueryValidator : AbstractValidator<GetExpensesQuery>
{
    ...
    public GetExpensesQueryValidator()
    {
        ...
        RuleFor(q => q.Cursor)
            .Must(cursor => cursor is null || ExpenseCursorCodec.TryDecode(cursor, out _))
    ...
    private static bool HaveConsistentDateRange(GetExpensesQuery query) =>
