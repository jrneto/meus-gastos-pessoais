...
public sealed partial class GetTransactionsQueryValidator : AbstractValidator<GetTransactionsQuery>
{
    ...
    public GetTransactionsQueryValidator()
    {
        ...
        RuleFor(q => q.Limit)
            ...
            .WithMessage($"limit deve estar entre 1 e {MaxLimit}.")
            .When(q => q.Limit is not null);

        RuleFor(q => q.Cursor)
            .Must(cursor => cursor is null || TransactionCursorCodec.TryDecode(cursor, out _))
    ...
    private static bool HaveConsistentDateRange(GetTransactionsQuery query) =>
